    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">Bienvenidos <br>A BOUTIQUE.</h1>
              <div class="buynow_bt"><a href="#">mas Informacion</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">Prociones <br>Y descuentos </h1>
              <div class="buynow_bt"><a href="#">mas Informacion</a></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital"><br>A BOUTIQUE</h1>
              <div class="buynow_bt"><a href="#">mas Informacion</a></div>
            </div>
          </div>
        </div>
