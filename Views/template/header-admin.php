...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo BASE_URL; ?>assets/images/logo1.png">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo BASE_URL; ?>" target="_blank">
        <img src="<?php echo BASE_URL; ?>assets/images/logo1.png" class="navbar-brand-img h-100" alt="main_logo1">
        <span class="ms-1 font-weight-bold text-white">A BOUTIQUE</span>
      </a>
    </div>
