   ...
   <div class="banner_bg_main">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="custom_menu">
                     <ul>
                        <li><a href="http://localhost/tiendaonline/admin/home">Moda que Inspira</a></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <div class="logo_section">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <div class="logo"><a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>assets/images/logo1.png" width="50"></a></div>
               </div>
            </div>
         </div>
      </div>
